...
} elseif ($_instance->childHasBeenRendered('c2XEqgE')) {
    $componentId = $_instance->getRenderedChildComponentId('c2XEqgE');
    $componentTag = $_instance->getRenderedChildComponentTagName('c2XEqgE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c2XEqgE');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('c2XEqgE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
